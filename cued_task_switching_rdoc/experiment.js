...
function assessPerformance() {
  ...
  var experiment_data = jsPsych.data
    .get()
    .filter({ exp_stage: "test", trial_id: "test_trial" }).trials;
  var missed_count = 0;
  var trial_count = 0;
  var rt_array = [];
  var rt = 0;
...
var appendData = function () {
  ...
  var trial_id = jsPsych.data.get().filter({ trial_index: curr_trial })
    .trials[0].trial_id;
...
var response_keys = {
  ...
  key_description: ["comma", "period"],
}; // haven't implemented counterbalancing!!!
...
var task_list =
  ...
  '<li>Cue: "Parity" or "Odd-Even". Response: Press your <b>' +
  response_keys.key_name[0] +
  "</b> if even and your <b>" +
  response_keys.key_name[1] +
  "</b> if odd.</li>" +
  '<li>Cue: "Magnitude" or "High-Low". Response: Press your <b>' +
  response_keys.key_name[0] +
  "</b> if the number is greater than 5 and your <b>" +
  response_keys.key_name[1] +
  "</b> if less than 5.</li>" +
  "</ul>";
...
var prompt_task_list =
  "<ul style='text-align:left'>" +
  '<li>"Parity" or "Odd-Even": ' +
  response_keys.key_name[0] +
  " if even and " +
  response_keys.key_name[1] +
  " if odd.</li>" +
  '<li>"Magnitude" or "High-Low": ' +
  response_keys.key_name[0] +
  " if >5 and " +
  response_keys.key_name[1] +
  " if <5.</li>" +
...
var instructions_block = {
  ...
  pages: [
    "<div class = centerbox><p class = block-text>In this experiment you will respond to a sequence of numbers.</p>" +
      ...
      response_keys.key_name[0] +
      "</b> on the <i>" +
      response_keys.key_description[0] +
      "</i> key (" +
      response_keys.key[0] +
      ") and your <b>" +
      response_keys.key_name[1] +
      "</b> on the <i>" +
      response_keys.key_description[1] +
      "</i> key (" +
      response_keys.key[1] +
      ") </p>" +
  ...
  loop_function: function (data) {
    ...
    if (accuracy > accuracy_thresh || practiceCount == practice_thresh) {
      feedback_text =
        ...
        "</div>";
      task_switches = jsPsych.randomization.repeat(
        task_switches_arr,
        numTrialsPerBlock / 4
      );

...
function assessPerformance() {
  ...
  var avg_rt = null;
  if (rt_array.length !== 0 && rt_array.every((value) => value !== undefined)) {
...
// for testing -- shorter version
// var practice_len = 2; // must be divisible by shapes.length * stop_signal_conditions.length
// var numTrialsPerBlock = (48 / 48) * 2; // must be divisible by shapes.length * stop_signal_conditions.length
// var numTestBlocks = 2;

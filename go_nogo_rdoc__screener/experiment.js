...
var expID = "go_nogo_rdoc__screener";
...
var go_nogo_rdoc__screener_experiment = [];
var go_nogo_rdoc__screener_init = () => {
  blockStims = jsPsych.randomization.repeat(
    practiceStimuli,
    practiceLen / practiceStimuli.length
  );

  go_nogo_rdoc__screener_experiment.push(fullscreen);
  go_nogo_rdoc__screener_experiment.push(instructionNode);
  go_nogo_rdoc__screener_experiment.push(practiceNode);
  go_nogo_rdoc__screener_experiment.push(postTaskBlock);
  go_nogo_rdoc__screener_experiment.push(endBlock);
  go_nogo_rdoc__screener_experiment.push(exitFullscreen);
};

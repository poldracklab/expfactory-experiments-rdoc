...
stroop_rdoc__screener_experiment = [];
var stroop_rdoc__screener_init = () => {
  // Randomly select two congruent and two incongruent stimuli
  let selectedCongruent = getRandomElements(congruentStim, 2);
  let selectedIncongruent = getRandomElements(incongruentStim, 2);
  // Combine the selected stimuli into a new array
  ...
  stroop_rdoc__screener_experiment.push(fullscreen);
  stroop_rdoc__screener_experiment.push(instructionsNode);
  stroop_rdoc__screener_experiment.push(practiceNode);
  stroop_rdoc__screener_experiment.push(postTaskBlock);
  stroop_rdoc__screener_experiment.push(endBlock);
  stroop_rdoc__screener_experiment.push(exitFullscreen);
};

...
var end_block = {
  ...
  data: {
    trial_id: "end",
    exp_id: "spatial_task_switching_rdoc__screener",
    trial_duration: 180000,
  },
  trial_duration: 180000,
  stimulus: endText,
...
spatial_task_switching_rdoc__screener_experiment = [];

var spatial_task_switching_rdoc__screener_init = () => {
  jsPsych.pluginAPI.preloadImages(images);
  task_switches = makeTaskSwitches(practiceLen);
  stims = createTrialTypes(task_switches);
  spatial_task_switching_rdoc__screener_experiment.push(fullscreen);
  spatial_task_switching_rdoc__screener_experiment.push(instruction_node);
  spatial_task_switching_rdoc__screener_experiment.push(practiceNode);
  spatial_task_switching_rdoc__screener_experiment.push(postTaskBlock);
  spatial_task_switching_rdoc__screener_experiment.push(end_block);
  spatial_task_switching_rdoc__screener_experiment.push(exit_fullscreen);
};

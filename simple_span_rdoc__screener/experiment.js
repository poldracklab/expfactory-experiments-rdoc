...
var endBlock = {
  ...
  data: {
    trial_id: "end",
    exp_id: "simple_span_rdoc__screener",
    trial_duration: 180000,
  },
  trial_duration: 180000,
  stimulus: endText,
...
simple_span_rdoc__screener_experiment = [];
var simple_span_rdoc__screener_init = () => {
  simple_span_rdoc__screener_experiment.push(fullscreen);
  simple_span_rdoc__screener_experiment.push(instructionNode);
  simple_span_rdoc__screener_experiment.push(practiceNode);
  simple_span_rdoc__screener_experiment.push(postTaskBlock);
  simple_span_rdoc__screener_experiment.push(endBlock);
  simple_span_rdoc__screener_experiment.push(exitFullscreen);
};

...
var practiceNode = {
    ...
    loop_function: function(data) {
        ...
        if (accuracy > accuracy_thresh || practiceCount == practice_thresh) {
            ...
            feedback_text = "<p class = block-text>Please take this time to read your feedback! This screen will advance automatically in 1 minute.</p>"
...
var testNode = {
    ...
    loop_function: function(data) {
        ...
        if (testCount >= numTestBlocks) {
            ...
            feedback_text = "<p class = block-text>Please take this time to read your feedback! This screen will advance automatically in 1 minute.<br>"
